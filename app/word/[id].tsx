...
export default function EditWordScreen() {
  ...
  const { state, updateWord, deleteWord } = useVocabulary();
  ...
  const handleSave = async () => {
    ...
    try {
      await updateWord(id!, portuguese, french, examples);
      router.back();
    } catch (error) {
      Alert.alert('Erreur', 'Échec de la mise à jour du mot');
      console.error(error);
    }
  };
  ...
  const handleDelete = () => {
    Alert.alert(
      'Supprimer le mot',
      `Êtes-vous sûr de vouloir supprimer "${portuguese}" ?`,
      [
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.form}>
          ...
          <TouchableOpacity style={styles.deleteButton} onPress={handleDelete}>
            ...
            <Text style={styles.deleteButtonText}>Supprimer le mot</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
